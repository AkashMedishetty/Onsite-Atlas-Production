 ...
 */
// Accept either (statusCode, message)  or  (message, statusCode)
const createApiError = (arg1, arg2) => {
  let statusCode;
  let message;

  // If developer passed (message, statusCode) swap them
  ...
  return { statusCode, message, isOperational: true };
};
